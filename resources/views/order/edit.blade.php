            ...
            <div class="order__subheader">
                <form class="order__form" action="{{ route('orders.update', $order) }}" method="POST">
                    ...
                    <input type="hidden" name="status"
                           value="{{ $order->status === \App\Models\Order::STATUS_ORDERED ? \App\Models\Order::STATUS_OPEN : \App\Models\Order::STATUS_ORDERED }}">

                    <button type="submit">
                        {{ $order->status === \App\Models\Order::STATUS_ORDERED ? __('Mark as open') : __('Mark as ordered') }}
                    </button>
                </form>
                                ...
                                <li class="order-item__user">
                                    ...
                                    <div class="order-item__actions">
                                        <a href="{{route('order_items.edit', $orderItem)}}">
                                            @svg('solid/pen', ['role="presentation"', 'aria-hidden="true"',
                                            'focusable="false"'])
